...
const i18n = new VueI18n({
  ...
  messages: {
    zh: {
      ...
      helloWord: '您好！👋',
      para1:'嗨，您好，我是田梓衡。',
      para2:'我十分热爱UI设计。跃动在屏幕上的符号、优雅的线条几何呈现、创意十足的点线面结合，这便是我所热爱的、所追寻的事物。作为未来发展和个人理想抱负而言，为了更好的理解开发、更好的结合设计与开发，高效输出开发可用的UI设计，我还浅显学习使用React Native做过App、使用Vue + Nuxt快速搭建网站，作为全栈完成过一个完整的App作品。当然，这些都是开源的。',
      para3:'在大学课余时间，我通过旁听其他专业课程、选修相关专业课程等方式，学习并掌握了平面设计、Ae动态动效设计、UI设计理论、VI系统设计理论、C4D建模、Redshift渲染技能，并将这些融会贯通。',
      para4:'我也紧跟当下AI辅助创作的设计前沿，掌握包括Stable Diffusion在内的AI创作工具的使用方法，并掌握将AI辅助创作融入工作流的方法论。',
