...
const i18n = new VueI18n({
  ...
  messages: {
    en: {
      ...
      personInfo4:'EMail Address: tzh894895@gmail.com',
    ...
    zh: {
      ...
      helloWord: '你好！👋',
      para1:'嗨，你好，我是 Patrick Tien，是一名高校在校学生，目前正在学习环境设计专业。',
      ...
      personInfo1:'姓名：Patrick Tien',
      personInfo2:'年龄：19',
      personInfo3:'我会：视频剪辑、UI设计、室内设计、前端开发。',
      personInfo4:'邮箱地址：tzh894895@gmail.com',
      personInfo5:'性别：男 ♂',
      tagName:' 标签',
      tag1:'UI/UX',
      tag2:'摄影',
